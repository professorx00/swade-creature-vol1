(() => {
  const adventureName = 'Savage World Creatures vol1';
  const moduleName = 'savage-world-creatures-vol1';
   ...
   */
  const welcomeJournal = 'swade-creature-vol1';
  /**
   ...
   */
  const additionalModulePacks = ["savage-world-creatures-vol1","swade-creatures-vol1"];
